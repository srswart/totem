...
use crate::schema::{
    ...
    ACCESS_LOG_SCHEMA_V2, CREDENTIAL_SCHEMA_V10, CURATION_SCHEMA_V6, EMBEDDING_MODEL_SCHEMA_V11,
    LANDSCAPE_SYNC_SCHEMA_V3, MEMORY_SCHEMA_V1, PROMOTION_SCHEMA_V5, REPO_GIT_IDENTITY_SCHEMA_V8,
};
